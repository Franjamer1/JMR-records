...
//             if (formElements[i].nodeName === "INPUT" && formElements[i].hasAttribute("required")) {
...
//         if (allFieldsFilled) {
//             // Si todos los campos están llenos, enviar la información al backend
//             postData();
//         } else {
//             // Mostrar un toast indicando que hay campos requeridos vacíos
